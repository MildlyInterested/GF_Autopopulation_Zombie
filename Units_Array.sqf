...
diag_log "//___________________ GF Auto Population Zombie Units Array initializing  ________________";
...
//	Your Custom
GF_APZ_Custom_1 = ["addclassnames","addclassnames"];

	
diag_log "//___________________ GF Auto Population Zombie Units Array initialized  ________________";