...
//___________________	GF_APZ_DynamicSimulation	___________________
...
if(GF_APZ_DynamicSimulation_auto_distance) then {
...
[] spawn {
	...
	"Group" setDynamicSimulationDistance GF_APZ_DynamicSimulation_manual_distance;
	};