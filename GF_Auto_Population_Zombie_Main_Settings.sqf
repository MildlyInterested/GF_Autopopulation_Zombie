...
diag_log "//______________________	GF Auto Population Zombie Main Settings initializing	___________________";
...
*/
[] execVM "GF_Auto_Population_Zombie\GF_APZ_Auto_Random_Loadout\Credits.sqf";	// Please keep the Credits or add them to your Diary
if(GF_APZ_Auto_Random_Loadout_Enabled) then {
[] execVM "GF_Auto_Population_Zombie\GF_APZ_Auto_Random_Loadout\GF_APZ_Auto_Random_Loadout.sqf";
};
...
*/
[] execVM "GF_Auto_Population_Zombie\GF_APZ_Units_Map_Markers\Credits.sqf";	// Please keep the Credits or add them to your Diary
if (GF_APZ_Units_Map_Markers_Enabled) then {
if (GF_APZ_Hintsilent_info) then {
hintsilent "Debug Markers Enabled";
};
[] execVM "GF_Auto_Population_Zombie\GF_APZ_Units_Map_Markers\GF_APZ_Units_Map_Markers.sqf";
};	


//______________________ GF_APZ_DynamicSimulation	______________________
if (GF_APZ_DynamicSimulation) then {
[] execVM "GF_Auto_Population_Zombie\GF_APZ_DynamicSimulation\GF_APZ_DynamicSimulation.sqf";
};	


//______________________ Show Server Systemchat information	______________________
if (GF_APZ_Show_Server_info) then {
[] execVM "GF_Auto_Population_Zombie\Server_info.sqf";
};	


//______________________ Start Spawner	______________________

[] execVM "GF_Auto_Population_Zombie\GF_Auto_Population_Zombie_Spawner.sqf";


diag_log "//______________________	GF Auto Population Zombie Main Settings initialized	___________________";
diag_log "//______________________	GF Auto Population Zombie Start Spawner	___________________";