...
while {true} do  {uisleep 1;!(isNull (findDisplay 46))};

//Credits
_subject = player createDiarySubject ["GF Auto Population Zombie Script - Mod", "GF Auto Population Zombie Script - Mod"];
_log_briefing = player createDiaryRecord ["GF Auto Population Zombie Script - Mod", ["About and Credits", "

<br /><font size='30' color='#FF0000'>GF Auto Population Zombie Script - Mod
<br />
...
<br />
<br /><font size='17' color='#0059B0'>GF Auto Population Zombie Script - Mod
<br />
<br />
<br /><font size='15' color='#A1D2FA'>
<br />
GF Auto Population Zombie Script - Mod  , will work automatically and populate every Map and Water Maps as well , with enemies on infinite , 
